...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.5\textwidth]{./graf/Logo-Uniwersytet_Ekonomiczny_w_Katowicach_granatowe_na_bialym_tle.png}
...
%         \includegraphics[width=\textwidth]{./graf/Logo-Uniwersytet_Ekonomiczny_w_Katowicach_granatowe_na_bialym_tle.png}
